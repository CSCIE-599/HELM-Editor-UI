...
describe('Controller: MainCtrl', function () {
 ...
 it('should invoke factory to get HELM notation', function () {

 });

 it('should invoke factory to validate the HELM notation', function () {

 });

 it('should invoke factory to get molecular weight', function () {
...
it('should make the connections requested in HELM Notation', function () {
 
   
});

it('should return source node id and dest node id for cyclical connections', function () {
 

  
});

it('should slice a given sequence into cycles and linear sub-sequences', function () {
...
//function returns source node id and dest node id for cyclical connections
...
it('should convert from titles to types', function () {
