...
describe('Directive: helmCanvas', function () {
  ...
  beforeEach(inject(function (_$compile_, $rootScope, _$httpBackend_) {
    ...
    $httpBackend.whenGET('MonomerDBGZEncoded.xml').respond(getDatabaseXML());
    // and mock the categorization databse
    $httpBackend.whenGET('DefaultMonomerCategorizationTemplate.xml').respond(getDefaultCategorizationXML());
    $httpBackend.flush();
  }));
